"""
Shared middleware for the Restaurant Management System.
"""
import json
import logging
...
class RequestBodyMiddleware(MiddlewareMixin):
    """
    Middleware to parse and attach JSON request body to request object.
    Makes request body accessible as request.body_data.
    """
...
class OperationLogMiddleware(MiddlewareMixin):
    """
    Middleware to automatically log CREATE and UPDATE operations.
