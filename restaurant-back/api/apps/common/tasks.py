...
async def listen_to_db():
    """
    Listen to PostgreSQL NOTIFY events on 'order_channel'.
    Broadcasts notifications to WebSocket group 'orders'.
    
    This allows database triggers to push real-time updates to clients.
    """
